...
import * as renovateConfig from './renovate-config/index.ts';
import * as rubyVersion from './ruby-version/index.ts';
import * as runtimeVersion from './runtime-version/index.ts';
import * as rustToolchain from './rust-toolchain/index.ts';
...
import * as vcpkgPortfile from './vcpkg-portfile/index.ts';
...
api.set('renovate-config', renovateConfig);
api.set('ruby-version', rubyVersion);
api.set('runtime-version', runtimeVersion);
api.set('rust-toolchain', rustToolchain);
api.set('sbt', sbt);
...
api.set('vcpkg-portfile', vcpkgPortfile);
